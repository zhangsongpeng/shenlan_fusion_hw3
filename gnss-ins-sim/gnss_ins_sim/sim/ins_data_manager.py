...
class InsDataMgr(object):
    ...
    def __init__(self, fs, ref_frame=0):
        ...
        self.bg = Sim_data(name='bg',\
                             description='gyro bias',\
                             units=['rad/s', 'rad/s', 'rad/s'],\
                             output_units=['deg/s', 'deg/s', 'deg/s'],\
                             legend=['bg_x', 'bg_y', 'bg_z'])
        self.ba = Sim_data(name='ba',\
                              description='accel bias',\
                              units=['m/s^2', 'm/s^2', 'm/s^2'],\
        ...
        self.__all = {
            ...
            self.bg.name: self.bg,
            self.accel.name: self.accel,
            self.ba.name: self.ba,
